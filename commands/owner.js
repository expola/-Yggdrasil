...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      const youtubeLink = 'segredo';
      const InstagramLink = 'segredooo';
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'segredoooo'
            ...
            .setDescription(`__**Sobre mim**__:\n\n ▶️ Eu mesmo, luiz, também conhecido como expola. entrando no mundo de desenvolvimento. Adoro jogar, assistir animes e construir diferentes aplicações.❤️`)
            .setTimestamp();
