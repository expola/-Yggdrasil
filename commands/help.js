  ...
  run: async (client, interaction) => {
    try {
      const musicCommandsEmbed = new EmbedBuilder()
        ...
        .setTitle('🎸 **Comandos Iniciais**')
        .addFields(
          { name: '🎹 Play', value: 'Transmita uma música de um texto ex:[Mae do azzip] nao pode links' },
      ...
      const button1 = new ButtonBuilder()
        .setLabel('YouTube')
        .setURL('https://youtu.be/XyYJ1oXO64Q?list=RDMMXyYJ1oXO64Q')
        .setStyle(ButtonStyle.Link);

      const button2 = new ButtonBuilder()
        .setLabel('Discord')
        .setURL('https://discord.gg/7MFGDxX8Uk')
        .setStyle(ButtonStyle.Link);
